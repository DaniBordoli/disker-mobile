...
type ApprovedProposalScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'ApprovedProposal'>;

export const ApprovedProposalScreen: React.FC = () => {
  const navigation = useNavigation<ApprovedProposalScreenNavigationProp>();

  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: '#125133' }}>
      <StatusBar barStyle="light-content" backgroundColor="#125133" />
      ...
      >
        ...
        <View className="pb-6 relative" style={{ backgroundColor: '#125133' }}>
        ...
        <View className="flex-1">
          <View className="bg-white rounded-t-3xl p-4 flex-1" style={{ borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingTop: 40 }}>
            ...
            <View className="items-center mb-6">
              <HeadingM className="text-primary-950 mb-1">Propuesta aprobada</HeadingM>
